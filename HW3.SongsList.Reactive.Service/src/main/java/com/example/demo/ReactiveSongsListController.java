...
//					.getSongsListById(listId)
	...
	@RequestMapping(path = "/lists/{listId}", method = RequestMethod.PUT, consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.TEXT_EVENT_STREAM_VALUE)
	public Mono<Void> updateSongsListById(@PathVariable("listId") String listId, @RequestBody SongsList songsList) {
	...
	@RequestMapping(path = "/lists/{listId}", method = RequestMethod.PUT, consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.TEXT_EVENT_STREAM_VALUE)
	public Mono<Void> unMarkSongsInSongsListByIdAsDeleted(@PathVariable(name = "listId") String listId) {

		return Mono.empty();
	}

	@RequestMapping(path = "/lists/{listId}/songs", method = RequestMethod.PUT, consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.TEXT_EVENT_STREAM_VALUE)
	public Mono<Void> addSongToListById(@PathVariable("listId") String listId, @RequestBody SongsList songsList) {
		// TODO: addSongToListById #4
		return Mono.empty();
	}

	@RequestMapping(path = "/lists/{listId}/songs/{songId}", method = RequestMethod.DELETE)
	public Mono<Void> deleteSongByIdFromListById(@PathVariable("listId") String listId,
			@PathVariable("songId") String songId) {
		// TODO: deleteSongByIdFromListById #5
		return Mono.empty();
	}

	@RequestMapping(path = "/lists/{listId}/songs?sortAttr={sortAttr}&orderAttr={orderAttr}", method = RequestMethod.GET, produces = MediaType.TEXT_EVENT_STREAM_VALUE)
	public Flux<SongDTO> getAllSongsFromSongsListById(@PathVariable("listId") String listId,
	...
	@RequestMapping(path = "/lists/byUser/{userEmail}?sortAttr={sortAttr}&orderAttr={orderAttr}", method = RequestMethod.GET, produces = MediaType.TEXT_EVENT_STREAM_VALUE)
	public Flux<SongsListDTO> getAllSongsListsByUser(@PathVariable(name = "userEmail") String userEmail,
			@RequestParam(name = "sortAttr", required = false, defaultValue = "id") String sortAttr,
			@RequestParam(name = "orderAttr", required = false, defaultValue = "ASC") String orderAttr) {
	...
	@RequestMapping(path = "/lists/bySongId/{songId}?sortAttr={sortAttr}&orderAttr={orderAttr", method = RequestMethod.GET, produces = MediaType.TEXT_EVENT_STREAM_VALUE)
	public Flux<SongsListDTO> getAllSongsListsContainsSongById(@PathVariable(name = "songId") String songId,
			@RequestParam(name = "sortAttr", required = false, defaultValue = "id") String sortAttr,
			@RequestParam(name = "orderAttr", required = false, defaultValue = "ASC") String orderAttr) {
	...
	@RequestMapping(path = "/lists", method = RequestMethod.DELETE)
	public Mono<Void> deleteAllSongsLists() {
		// TODO: deleteAllSongsLists #10
		return Mono.empty();
	}

	@RequestMapping(path = "/lists/{listId}", method = RequestMethod.DELETE)
	public Mono<Void> markSongsInSongsListByIdAsDeleted(@PathVariable(name = "listId") String listId) {
